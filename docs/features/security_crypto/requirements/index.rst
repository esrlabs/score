...
.. feat_req:: Message Authentication Code
   ...
   The security subsystem shall provide functionality for Message Authentication Codes (MAC) to
...
.. feat_req:: Key Derivation
   ...
   The security subsystem shall provide Key Derivation Functions (KDFs) to derive one or more
...
.. feat_req:: Certificate Management
   ...
   The security subsystem shall provide functionality to manage a set of signed and verified
...
.. feat_req:: Secure Key Update
   :id: feat_req__sec_crypt__key_update
   :reqtype: Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__dependability__security_features
...
.. feat_req:: Standardized Algorithm Naming
   ...
   The security subsystem shall use a uniform and unambiguous naming scheme for cryptographic
   algorithms.
...
.. feat_req:: API Lifecycle Management
   ...
   The security subsystem API shall provide clear mechanisms for initialization, context management
...
.. feat_req:: Structured Error Handling
   ...
   The security subsystem shall provide a structured and consistent mechanism for error reporting
   and logging.
...
.. feat_req:: Security Plan
   :id: feat_req__sec_crypt__security_plan
   :reqtype: Non-Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__dependability__security_features
   ...
   A security plan shall be created for the security subsystem, including security goals, plausible
   attacks, critical failures, and countermeasures.

.. feat_req:: Software Update Strategy
   :id: feat_req__sec_crypt__update_strategy
   :reqtype: Non-Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__dependability__security_features
...
.. feat_req:: Field Observation Strategy
   :id: feat_req__sec_crypt__field_observation
   :reqtype: Non-Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__dependability__security_features
...
.. feat_req:: Repairability Strategy
   :id: feat_req__sec_crypt__repairability
   :reqtype: Non-Functional
   :security: YES
   :safety: QM
   :satisfies: stkh_req__dependability__security_features
...
.. feat_req:: Reverse Engineering Protection
   ...
   The security plan shall ensure the security subsystem can withstand reverse engineering of its
   secrets.
...
.. feat_req:: Initial Production Key Handling
   ...
   The security subsystem shall consider the production scenario where initial production keys are
...
.. feat_req:: Hardware Acceleration Support
   ...
   The security subsystem shall be able to rely on hardware acceleration for cryptographic
   operations.
...
.. feat_req:: OS-Level Protection
   ...
   The security subsystem shall use system-level means (e.g., co-processor, HSM, TEE) to protect
...
.. feat_req:: Access Control
   ...
   The security subsystem shall support roles and capability rights management to enforce access
...
.. feat_req:: Intrusion Detection System (IDS) Integration
   ...
   The security subsystem shall provide a mechanism to report potential security anomalies or
...
.. feat_req:: Denial-of-Service (DoS) Mitigation
   ...
   The security subsystem shall incorporate measures to mitigate the risk of Denial-of-Service
   (DoS) attacks that could be caused by malicious messages creating exceptional computational load.
...
.. feat_req:: TLS Support
   ...
   The security subsystem shall support the Transport Layer Security (TLS) 1.3 protocol for secure
